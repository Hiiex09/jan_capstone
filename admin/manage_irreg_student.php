...
<head>
  ...
  <title>Manage & Assign Irregular Student</title>
</head>

<body>
  <div class="lg-container w-full p-4">
    <div class="p-4">
      <h1 class="text-4xl">Assign Teacher and Subject to Student For Irregular Student</h1>
    </div>
    ...
    <div class="flex justify-start p-4">
      <form>
        <div>
          <div class="mt-5">
            <div class="m-2">
              <label class="text-2xl">Select Student</label>
            </div>
            <div>
              <select
